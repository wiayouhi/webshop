...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 31, 2026 at 05:51 PM
...
INSERT INTO `orders` (`id`, `user_id`, `product_id`, `product_name`, `price`, `data_received`, `purchased_at`, `status`, `note`, `status_text`, `shipping_address`, `shipping_name`, `shipping_phone`, `tracking_number`) VALUES
(1, 1, 2, 'สินค้าตัวอย่าง', 99.00, 'test', '2026-01-07 14:28:35', 'success', NULL, NULL, NULL, NULL, NULL, NULL),
(2, 1, 2, 'สินค้าตัวอย่าง', 99.00, 'test', '2026-01-13 12:44:27', 'success', NULL, NULL, NULL, NULL, NULL, NULL),
(3, 1, 2, 'สินค้าตัวอย่าง', 99.00, 'test', '2026-01-13 12:44:27', 'success', NULL, NULL, NULL, NULL, NULL, NULL),
(4, 1, 2, 'สินค้าตัวอย่าง', 99.00, 'test', '2026-01-13 12:44:27', 'success', NULL, NULL, NULL, NULL, NULL, NULL),
(5, 1, 2, 'สินค้าตัวอย่าง', 99.00, 'test', '2026-01-13 12:44:27', 'success', NULL, NULL, NULL, NULL, NULL, NULL),
(6, 1, 2, 'สินค้าตัวอย่าง', 99.00, 'test', '2026-01-13 12:44:27', 'success', NULL, NULL, NULL, NULL, NULL, NULL),
(7, 1, 2, 'สินค้าตัวอย่าง', 99.00, 'test', '2026-01-13 12:44:27', 'success', NULL, NULL, NULL, NULL, NULL, NULL),
(8, 1, 2, 'สินค้าตัวอย่าง', 99.00, 'test', '2026-01-13 12:44:27', 'success', NULL, NULL, NULL, NULL, NULL, NULL),
(9, 1, 2, 'สินค้าตัวอย่าง', 99.00, 'test', '2026-01-13 12:44:27', 'success', NULL, NULL, NULL, NULL, NULL, NULL);
...
(2, 1, 'สินค้าตัวอย่าง', '', 99.00, 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExMWJ6bnp2OGliOXlyazVlOHExcHFxMzZsNXY0aGloNWtjbnFoM2NzNSZlcD12MV9naWZzX3RyZW5kaW5nJmN0PWc/FY8c5SKwiNf1EtZKGs/giphy.gif', 0, 100, '2026-01-07 13:51:54', 'physical');
...
INSERT INTO `settings` (`id`, `site_name`, `site_logo`, `site_color`, `marquee_text`, `background_img`, `banner_img`, `truewallet_phone`, `line_url`, `facebook_url`, `discord_url`, `youtube_url`, `tiktok_url`, `instagram_url`, `angpao_api_key`, `angpao_api_url`, `promptpay_number`, `slip_api_key`, `angpao_status`, `promptpay_status`, `slip_check_api_key`, `background_type`, `background_list`, `floating_emojis`, `payment_tm_phone`, `payment_tm_api_url`, `payment_bank_acc`, `payment_bank_name`, `slip_api_token`, `discord_widget_id`, `theme_color`, `bg_color`, `text_color`, `discord_client_id`, `discord_client_secret`, `discord_redirect_uri`, `site_description`, `site_about`) VALUES
(1, 'My Shop', '', 'purple', 'Welcome to My Shop', NULL, '[\"https:\\/\\/tse4.mm.bing.net\\/th\\/id\\/OIP.mSHiRxz8GT4boAiZkxQRdQHaD4?rs=1&pid=ImgDetMain&o=7&rm=3\",\"https:\\/\\/ayanowa.com\\/wordpress\\/wp-content\\/uploads\\/2024\\/11\\/anime_catch.jpg\"]', '', '', '', '', '', '', '', NULL, NULL, NULL, NULL, 1, 1, NULL, 'image', '[]', '', '', '', NULL, NULL, NULL, '', '#e6a028', '#ffffff', '#000000', '1359887642409435326', 'Z-8mEtZ6eYFZ_MJrGccyfCySic1lpJue', 'http://localhost/api/discord_login.php', 'แหล่ง ไฟล์เว็บไซต์อับดับหนึ่ง', 'ร้านดีมาก');
